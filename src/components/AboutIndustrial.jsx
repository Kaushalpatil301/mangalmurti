            ...
            {[
              {
                ...
                title: "Internal Road",
                desc: "Road provided for 40ft container"
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="1.5">
                ...
                title: "Ring road",
                desc: "Bhiwandi ring road passes through park"
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="1.5">
                ...
                title: "Decorated Passage",
                desc: "Well-lit roads with lush greenery"
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="1.5">
              ...
              },
              {
                ...
                desc: "E-commerce & 3PL logistics network"
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="1.5">
                ...
                title: "Safe & Secure",
                desc: "24/7 Surveillance with Fire Safety & Fencing"
              }
            ].map((amenity, index) => (
              <div key={index} className="amenity-item">
                <div className="amenity-icon">{amenity.icon}</div>
                <h4 className="amenity-title font-inter font-medium">{amenity.title}</h4>
                <p className="amenity-desc text-xs text-gray-500 font-light">{amenity.desc}</p>
              </div>
            ))}
          </div>
        </div>
